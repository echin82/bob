...
export default defineConfig({
  ...
  server: {
    ...
    proxy: {
      // Forward upload and contract API calls to the Node.js backend.
      // This avoids CORS configuration during development (TASK-FE-01).
      '/upload': 'http://127.0.0.1:3001',
      '/contracts': 'http://127.0.0.1:3001',
      '/findings': 'http://127.0.0.1:3001',
